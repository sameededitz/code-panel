...
```bash
git clone https://github.com/TeccClubb/ORYX-VPN-Panel.git
cd ORYX-VPN-Panel
...
-   **License:** MIT
-   **Contributors:** [sameededitz](https://github.com/sameededitz)
